...
このツールは4つの主要機能で株式市場学習をサポートします：

### 📊 **ポートフォリオ管理**
- SBI・楽天証券のCSVを自動解析してポートフォリオを可視化
- リアルタイム株価による評価額・損益の更新
- 利確15%・損切-8%ルールによる投資アドバイス
...
### 🎯 **投資戦略分析**
- ディフェンシブ・グロース・バリュー・配当・モメンタムの5戦略
- 各戦略100点満点での定量的スコア算出
- データ品質による信頼度調整機能
...
- [📁 プロジェクト構造](#📁-プロジェクト構造)
- [📊 データソース](#📊-データソース)
- [⚙️ 設定・カスタマイズ](#⚙️-設定カスタマイズ)
- [💾 データ保存場所](#💾-データ保存場所)
- [🛡️ セキュリティ・プライバシー](#🛡️-セキュリティプライバシー)
- [🆘 サポート・コミュニティ](#🆘-サポートコミュニティ)
- [🎯 プロジェクト哲学](#🎯-プロジェクト哲学)
- [⚠️ 免責事項・利用規約](#⚠️-免責事項利用規約)
